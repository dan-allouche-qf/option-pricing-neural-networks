...
\midrule
$m = S/K$    & $[0.4, 1.6]$   & $[0.5, 1.4]$                & $[0.6, 1.4]$ \\
$\tau$       & $[0.2, 1.1]$   & $[0.05, 1.0]$               & $[0.1, 1.4]$ \\
$r$          & $[0.02, 0.1]$  & $[0.0, 0.1]$                & $[0.0, 0.10]$ \\
$\sigma$     & $[0.01, 1.0]$  & $[0.05, 1.0]$ (then derive $V/K$) & --- \\
...
training), and a \emph{narrow} test set on the narrow range of Table 4 of the
article, namely $m \in [0.5, 1.5]$, $\tau \in [0.3, 0.95]$, $r \in [0.03, 0.08]$,
$\sigma \in [0.02, 0.9]$, drawn from an independent LHS seed and restricted to
the region where most practical options live.
